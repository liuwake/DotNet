...
public partial class HDevelopExport
{
  ...
  public HDevelopExport()
  {
    ...
    HOperatorSet.SetSystem("width", 600);
    ...
    try
    {
      ...
      while ((int)(1) != 0)
      {
        ...
        try
        {
          ...
          if (HDevWindowStack.IsOpen())
          {
            HOperatorSet.DispObj(ho_InfoTransContours, HDevWindowStack.GetActive()
                );
          }
          //* Ocr
          if (HDevWindowStack.IsOpen())
          {
            using (HDevDisposeHelper dh = new HDevDisposeHelper())
            {
            HOperatorSet.DispText(HDevWindowStack.GetActive(), hv_Ocr_Split, "image", 
                hv_IDRow1+hv_IDHeight, hv_IDColumn1, "blue", new HTuple(), new HTuple());
            }
          }
          //* Sign
